        ...
        >
          ...
          >
            ...
            <div className="w-full h-[50px] px-4 my-2 justify-between items-center inline-flex">
              {breadcrumb.length <= 1 ? (
                <button className="w-full h-[50px] px-4 items-center gap-1 flex rounded-lg border-[#0174bb] shadow border justify-center text-[#0174bb]">
                  <IconGlobe />
                ...
                <div className="w-full h-[52px] px-6 py-3.5 rounded-lg shadow border border-[#0174bb] justify-between items-center inline-flex">
                  <Link href={breadcrumb[1].url || "/"}>
                    <p className="text-[#0174bb] text-base font-medium leading-normal text-left flex justify-between">
                      Tới trang {breadcrumb[1].title}
                    </p>
                  </Link>
                  <div className="w-6 h-6 relative text-[#0174bb]">
                    <IconArrowRight />
                  </div>
                </div>
              )}
